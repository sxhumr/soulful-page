...
const globalStyles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Custom dropdown arrow to prevent WebkitAppearance: 'none' from rendering a blank box on iOS */
  .sh-select {
    background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%236B4D57' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><polyline points='6 9 12 15 18 9'></polyline></svg>") !important;
  ...
  @media (max-width: 560px) {
    .responsive-grid {
      ...
      gap: 16px !important; /* Retained safe layout separation on narrow devices */
    }
    .page-wrapper {
...
const inputStyle = {
  ...
  color: theme.textDark,
  background: theme.white,   /* Flipped slightly brighter to guarantee visible inputs across all mobile configurations */
  outline: 'none',
...
export default function BookingPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Points securely to your corresponding backend handler matching your folder schema
